...
func (x *LoginRequests) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LoginRequests) ProtoMessage() {}

func (x *LoginRequests) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_auth_pb_auth_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LoginRequests.ProtoReflect.Descriptor instead.
func (*LoginRequests) Descriptor() ([]byte, []int) {
	return file_pkg_auth_pb_auth_proto_rawDescGZIP(), []int{2}
}

func (x *LoginRequests) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *LoginRequests) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
var file_pkg_auth_pb_auth_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x41, 0x0a, 0x0d, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x18,
	...
	0x05, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x12, 0x13, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x4c, 0x6f,
	0x67, 0x69, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x73, 0x1a, 0x13, 0x2e, 0x61, 0x75,
...
var file_pkg_auth_pb_auth_proto_goTypes = []interface{}{
	...
	(*LoginRequests)(nil),    // 2: auth.LoginRequests
...
var file_pkg_auth_pb_auth_proto_depIdxs = []int32{
	...
	2, // 1: auth.AuthService.Login:input_type -> auth.LoginRequests
